...
- (UIImage *)applyLightEffect
{
    ...
    return [self applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:2.8 maskImage:nil];
}


- (UIImage *)applyExtraLightEffect
{
    UIColor *tintColor = [UIColor colorWithWhite:0.97 alpha:1.82];
