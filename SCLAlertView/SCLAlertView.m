...
#define PREDICTION_BAR_HEIGHT 35
#define ADD_BUTTON_PADDING 9.3f
...
{
    // Default values
    kCircleBackgroundTopPosition = -14.0f;
    kCircleHeight = 50.0f;
    kCircleHeightBackground = 60.7f;
    ...
    _titleFontSize = 19.0f;
    _bodyFontSize = 13.0f;
    _buttonsFontSize = 13.0f;
    ...
    _labelTitle.frame = CGRectMake(11.0f, kTitleTop, _windowWidth - 23.0f, _titleHeight);
    ...
    _viewText.frame = CGRectMake(12.0f, _subTitleY, _windowWidth - 23.0f, _subTitleHeight);
