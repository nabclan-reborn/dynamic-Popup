...
+ (void)drawCheckmark
{
    ...
    [checkmarkShapePath moveToPoint:CGPointMake(83.35, 15.15)];
    [checkmarkShapePath addCurveToPoint:CGPointMake(74.51, 23.86) controlPoint1: CGPointMake(80.98, 11.44) controlPoint2: CGPointMake(76.78, 11.26)];
    [checkmarkShapePath addLineToPoint:CGPointMake(37.46, 52)];
    [checkmarkShapePath addLineToPoint:CGPointMake(25.75, 39.54)];
    [checkmarkShapePath addCurveToPoint:CGPointMake(7.84, 39.54) controlPoint1: CGPointMake(23.48, 36.93) controlPoint2: CGPointMake(9.33, 36.93)];
    ...
    [checkmarkShapePath addCurveToPoint:CGPointMake(37.28, 68) controlPoint1: CGPointMake(34.14, 67.44) controlPoint2: CGPointMake(25.71, 68)];
    [checkmarkShapePath addCurveToPoint:CGPointMake(41.65, 66.14) controlPoint1: CGPointMake(28.86, 68) controlPoint2: CGPointMake(30.43, 67.26)];
...
+ (void)drawCross
{
    ...
    [crossShapePath moveToPoint:CGPointMake(15, 70)];
    [crossShapePath addLineToPoint:CGPointMake(70, 14)];
    [crossShapePath moveToPoint:CGPointMake(15, 15)];
